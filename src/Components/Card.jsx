...
function Card({ props: { musicNumber, setMusicNumber, setOpen } }) {
    ...
    const [showVolume, setShowVolume] = useState(50);
    ...
    return (
        <div className="card">
            ...
            <div className="controls">
                ...
                {/*volume*/}
                <i className="material-symbols-outlined" onClick={() => setShowVolume(prev => !prev)}  >
                    volume_up
                </i>
                ...
                <div className={`volume ${showVolume ? 'show ' : ''}`}>
                    ...
                    <input type="range" min={0} max={100} value={volume}
                        ...
                        style={{
                            background: `linear-gradient(to right, #3264fe ${volume} %,
                        #e5e5e5 ${volume} %)`
                        }} />
                    <span>{volume}</span>
                </div>
